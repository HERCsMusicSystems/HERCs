...
public:
	typedef void (* AudioCallback) (int frames, AudioBuffers * buffers);
	...
	void installInputCallback (AudioCallback callback);
	void installOutputCallback (AudioCallback callback);
	MultiplatformAudio (void * hwnd, int channels, int sampling_freq, int latency_samples);
